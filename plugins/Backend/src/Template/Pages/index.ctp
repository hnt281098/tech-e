    <body id="page-top">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane show active fade" id="messenger" aria-labelledby="messenger-tab">
                                        ...
                                        <div class="messenger-message messenger-message-sender">
                                            <?= $this->Html->image("Backend.avatar/avatar-02.jpg", ["alt"=>"...", "class"=>"messenger-image messenger-image-default"]); ?>
                                        ...
                                        <div class="messenger-message messenger-message-sender">
                                            <?= $this->Html->image("Backend.avatar/avatar-05.jpg", ["alt"=>"...", "class"=>"messenger-image messenger-image-default"]); ?>
                                            <div class="messenger-message-wrapper">
                                                <div class="messenger-message-content">
                                                    <p>
                                        ...
                                        <div class="quick-friends mt-3 mb-3">
                                            <ul class="list-group w-100">
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <?= $this->Html->image("Backend.avatar/avatar-02.jpg", ["alt"=>"...", "class"=>"img-fluid rounded-circle", "style"=>"width: 35px;"]); ?>
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <?= $this->Html->image("Backend.avatar/avatar-03.jpg", ["alt"=>"...", "class"=>"img-fluid rounded-circle", "style"=>"width: 35px;"]); ?>
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <?= $this->Html->image("Backend.avatar/avatar-04.jpg", ["alt"=>"...", "class"=>"img-fluid rounded-circle", "style"=>"width: 35px;"]); ?>
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <?= $this->Html->image("Backend.avatar/avatar-05.jpg", ["alt"=>"...", "class"=>"img-fluid rounded-circle", "style"=>"width: 35px;"]); ?>
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <?= $this->Html->image("Backend.avatar/avatar-06.jpg", ["alt"=>"...", "class"=>"img-fluid rounded-circle", "style"=>"width: 35px;"]); ?>
                                                        </div>
                                                        <div class="media-body align-self-center">
        ...
        <?php
            echo $this->Html->script(array(
                ...
                // '../template/js/jquery.magnific-popup.min',
                // // <!-- WayPoint Plugin JavaScript-->
                // '../template/js/jquery.waypoints.min',
                // // <!-- CounterUp Plugin JavaScript-->
                // '../template/js/jquery.counterup',
