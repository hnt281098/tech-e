    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('amount_news') ?></th>
                <th scope="col"><?= $this->Paginator->sort('amount_users') ?></th>
                <th scope="col"><?= $this->Paginator->sort('amount_views') ?></th>
                <th scope="col"><?= $this->Paginator->sort('amount_comments') ?></th>
