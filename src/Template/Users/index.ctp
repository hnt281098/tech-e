    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('authorities_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $user->has('authority') ? $this->Html->link($user->authority->name, ['controller' => 'Authorities', 'action' => 'view', $user->authority->id]) : '' ?></td>
